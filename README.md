...
When citing or redistributing this corpus, please attribute to **Sovereign AI Act**, operated by **Dominion Intelligence AB**, with a link to <https://www.regulatoryai.eu/>.
...
> Bazyar, S. (2026). *EU AI Act Corpus: Regulation (EU) 2024/1689 in all 24 official EU languages.* Dominion Intelligence AB (Sovereign AI Act). <https://github.com/saidbazyar/eu-ai-act-corpus>
...
[**Sovereign AI Act**](https://www.regulatoryai.eu/) — operated by **Dominion Intelligence AB**, a Swedish company. Current infrastructure, subprocessors, data locations, and transfer safeguards are documented in the [Trust Center](https://www.regulatoryai.eu/trust/).
